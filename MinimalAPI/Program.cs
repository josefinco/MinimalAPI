...
//Adiciona a configuração do JWT pegando a key "AppSettings dentro do appsettings.json//
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "Desenvolvido por: José finco",
        Contact = new OpenApiContact { Name = "José Finco", Email = "josefinco_@Hotmail.com" },
